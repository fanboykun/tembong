    ...
    <body class="font-sans antialiased">
                        ...
                        <ul class="py-1" role="none">
                          ...
                          <li class="justify-start">
                            <form method="POST" action="{{ route('logout') }}">
                                {{-- @method('POST') --}}
                                @csrf
                                <button type="submit" class="block px-4 py-2 w-full text-sm justify-start text-gray-700 hover:bg-gray-100" role="menuitem">Sign out</button>
                            </form>
                          </li>
                        </ul>
                      </div>
        ...
        <aside id="logo-sidebar-dashboard" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-1 shadow-md sm:translate-x-0" aria-label="Sidebar">
            ...
            <ul class="space-y-4 font-normal">
                <li>
                    <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-slate-700 rounded-lg hover:pl-3 hover:border-l hover:border-black text-base font-light leading-2 tracking-wide {{ request()->routeIs('dashboard') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : '' }}">
                ...
                <li>
                    <a href="{{ route('products.index') }}" class="flex items-center p-2 rounded-lg text-slate-700 hover:pl-3 hover:border-l hover:border-black text-base font-light leading-2 tracking-wide {{ request()->routeIs('products.*') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a href="{{ route('users.index') }}" class="flex items-center p-2 rounded-lg text-slate-700 hover:pl-3 hover:border-l hover:border-black text-base font-light leading-2 tracking-wide {{ request()->routeIs('users.*') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a href="{{ route('admin.index') }}" class="flex items-center p-2 rounded-lg text-slate-700 hover:pl-3 hover:border-l hover:border-black text-base font-light leading-2 tracking-wide {{ request()->routeIs('admin.*') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a href="{{ route('orders.index') }}" class="flex items-center p-2 rounded-lg text-slate-700 hover:pl-3 hover:border-l hover:border-black text-base font-light leading-2 tracking-wide {{ request()->routeIs('orders.*') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a href="{{ route('payments.index') }}" class="flex items-center p-2 rounded-lg text-slate-700 hover:pl-3 hover:border-l hover:border-black text-base font-light leading-2 tracking-wide {{ request()->routeIs('payments.*') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <ul class="space-y-4 font-normal">
                <li>
                    <a href="{{ route('dashboard-reseller') }}" class="flex items-center p-2 text-slate-700 rounded-lg {{ request()->routeIs('dashboard-reseller') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : ''}} hover:pl-3 hover:border-l hover:border-black">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z" />
                          </svg>
                ...
                <li>
                    <a href="{{ route('referral') }}" class="flex items-center p-2 text-slate-700 rounded-lg {{ request()->routeIs('referral') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : ''}} hover:pl-3 hover:border-l hover:border-black">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('sales') }}" class="flex items-center p-2 text-slate-700 rounded-lg {{ request()->routeIs('sales') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : ''}} hover:pl-3 hover:border-l hover:border-black">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a href="{{ route('balance.index') }}" class="flex items-center p-2 text-slate-700 rounded-lg {{ request()->routeIs('balance.*') ? 'text-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : ''}} hover:pl-3 hover:border-l hover:border-black">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
