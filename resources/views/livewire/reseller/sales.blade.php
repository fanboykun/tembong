                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-4">
                        <div>
                            ...
                            <x-text-input wire:model="sales_count" name="sales_count" disabled type="number" class="mt-1 block w-full"/>
                        </div>
                        <div>
                            <x-input-label for="sales_fee" :value="__('Total Sales Fee')" />
                            <x-text-input wire:model="sales_fee" name="sales_fee" disabled type="number" class="mt-1 block w-full"/>
                        </div>
                    </div>
                </div>
            </div>
