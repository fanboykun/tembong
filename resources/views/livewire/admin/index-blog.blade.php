    ...
    <x-modal name="delete-blog" >
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Hapus Blog ?</h3>
                <div class="mt-2">
            ...
            <button type="button" wire:click.prevent="deleteBlog()" x-on:click="$dispatch('close')" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Hapus</button>
            ...
            <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <a href="{{ route('blogs.create') }}" class="flex items-center justify-center text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <th scope="row" class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img src="{{ $blog->cover }}" alt="iMac Front Image" class="w-auto h-8 mr-3 rounded-lg">
                                    {{ $blog->title }}
                                </th>
                                <td class="px-4 py-2">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex gap-x-2 justify-center">
                                        ...
                                        <div class="relative top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg bg-red-600">
                                            <button x-data=""
                                                    wire:click="confirmingDeleteBlog({{ $blog->id }})"
                                                    type="button" >
                                                <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Menampilkan
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $blogs->count() }}</span>
                        dari
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $blogs->total() }}</span>
                    </span>
