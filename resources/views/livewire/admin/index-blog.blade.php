<div>
    ...
    <x-modal name="delete-blog" focusable>
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            ...
            <button type="button" wire:click="deleteBlog({{ $blog }})" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Hapus</button>
