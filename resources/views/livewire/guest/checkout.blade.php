...
<div class="isolate bg-white py-8 px-6 sm:py-8 lg:px-8">
    ...
    <div class="mx-auto mt-8 max-w-xl sm:mt-8">
        ...
        <div class="flex gap-x-4 sm:col-span-2 mt-4">
            ...
            <button type="button" wire:click="$toggle('isAgreed')" class="{{ $isAgreed ? 'bg-indigo-600' : 'bg-gray-200' }} flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" role="switch"/>
                <span class="sr-only">Agree to policies</span>
                <!-- Enabled: "translate-x-3.5", Not Enabled: "translate-x-0" -->
                <span aria-hidden="true" class=" {{ $isAgreed ? 'translate-x-3.5' : 'translate-x-0' }} h-4 w-4 transform rounded-full bg-white shadow-sm ring-1 ring-gray-900/5 transition duration-200 ease-in-out"></span>
            </button>
            </div>
        ...
        <div class="mt-4">
            <button type="submit" {{ $isAgreed ? '' : 'disabled' }} wire:click="prefilMessage()" class="block w-full rounded-md {{ $isAgreed ? 'bg-indigo-600 hover:bg-indigo-500' : 'bg-indigo-200' }}  px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Kirim</button>
        </div>
    </div>
</div>
</div>
