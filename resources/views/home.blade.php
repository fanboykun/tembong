...
@section('content')
    ...
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            ...
            <a href="{{ url('join-dropshipper') }}" class="text-sm font-semibold leading-6 text-gray-200">Dropshipper</a>
    ...
    <div class="bg-white py-16 sm:py-16 drop-shadow-sm" id="us">
        <div class="mx-auto grid max-w-7xl gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
          <div class="max-w-2xl">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">Di balik Mama Parfum, ada tim ahli yang senantiasa berinovasi dan bekerja keras untuk memberikan pengalaman terbaik bagi pelanggan kami.</p>
          </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-6 text-lg leading-8 text-gray-600">
                Kami menawarkan beragam Partnership untuk Anda yang ingin berbisnis dengan kami, seperti <a href="">Supplier</a>, <a href="{{ url('join-dropshipper') }}">Dropshipper</a>, <a href="">Reseller</a> dan <a href="">Dropshipper</a> Dengan berbagai macam keuntungan yang kami tawarkan, Anda akan mendapatkan keuntungan yang besar.
            </p>
          </div>
        </div>
    </div>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-16 lg:py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:max-w-none lg:grid-cols-2">
                ...
                <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Gabung Menjadi Dropshipper</h2>
                <p class="mt-4 text-lg leading-8 text-gray-300">
                    Raih kebebasan finansial dan waktu yang Anda inginkan. Dengan produk-produk berkualitas tinggi Anda dapat fokus pada menjual dan mempromosikan produk kami tanpa harus memikirkan hal lain.
                </p>
                <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                    ...
                    <a href="{{ url('/join-dropshipper') }}" class="text-sm font-semibold leading-6 text-white">Lebih Lanjut <span aria-hidden="true">→</span></a>
                </div>
                </div>
                <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                    <div class="flex flex-col items-start">
                        ...
                        <dt class="mt-4 font-semibold text-white">Produk Berkualitas</dt>
                        <dd class="mt-2 leading-7 text-gray-400">Berkesempatan memasarkan produk yang berkualitas tinggi dan memiliki popularitas yang tinggi</dd>
                    </div>
                    <div class="flex flex-col items-start">
                        <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                        ...
                        <dt class="mt-4 font-semibold text-white">Tanpa Ribet</dt>
                        <dd class="mt-2 leading-7 text-gray-400">Tidak perlu memikirkan stok atau pengiriman produk, karena kami akan menangani semuanya untuk Anda.</dd>
                    </div>
                </dl>
            </div>
            <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                <div class="flex flex-col-reverse">
                <dt class="text-base leading-7 text-gray-300">Di seluruh Indonesia</dt>
                <dd class="text-2xl font-bold leading-9 tracking-tight text-white">Tersebar</dd>
                </div>

                <div class="flex flex-col-reverse">
                <dt class="text-base leading-7 text-gray-300">Pilihan Produk</dt>
                <dd class="text-2xl font-bold leading-9 tracking-tight text-white">600+</dd>
                </div>

                <div class="flex flex-col-reverse">
                <dt class="text-base leading-7 text-gray-300">Jam dukungan</dt>
                <dd class="text-2xl font-bold leading-9 tracking-tight text-white">24</dd>
                </div>

                <div class="flex flex-col-reverse">
                <dt class="text-base leading-7 text-gray-300">Tanpa ribet</dt>
                <dd class="text-2xl font-bold leading-9 tracking-tight text-white">Effortless</dd>
                </div>
            </dl>
        </div>
        ...
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
          <figure class="mt-10">
            <blockquote class="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
              <p>“Kata Kata Tentang Bisnis Dropshipper Mama Parfum Oleh Owner. Nemo expedita voluptas culpa sapiente alias molestiae. Numquam corrupti in laborum sed rerum et corporis.”</p>
            </blockquote>
        ...
        <div class="flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
          ...
          <div class="md:w-7/12 lg:w-8/12 w-full md:mt-0 sm:mt-14 mt-10">
            ...
            <div x-data="{selected:1}">
                     ...
                     class="relative overflow-hidden transition-all max-h-0 duration-700"
                        ...
                        x-bind:style="selected == 1 ? 'max-height: ' + $refs.container1.scrollHeight + 'px' : ''">
                            <p id="para1" class="font-normal text-base leading-6 text-gray-600 mt-4 w-11/12">
                                pergi ke halaman <a href="{{ url('product') }}" class="text-indigo-500 font-bold">produk</a> lalu klik tombol jelajahi produk kami, lalu pilih produk yang anda inginkan, lalu klik tombol beli sekarang, lalu isi data diri anda, lalu klik tombol pesan sekarang, lalu tunggu konfirmasi dari kami.
                            </p>
                    </div>
                ...
                <div class="py-4">
                    <div class="flex justify-between items-center">
                        <h3 class="font-semibold text-xl leading-5 text-gray-800"> Bagaimana cara menjadi Dropshipper mama parfum ? </h3>
                        <button
                    ...
                    <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                        ...
                        x-bind:style="selected == 2 ? 'max-height: ' + $refs.container2.scrollHeight + 'px' : ''">
                            <p id="para1" class="font-normal text-base leading-6 text-gray-600 mt-4 w-11/12">
                                Silahkan pergi ke halaman <a href="{{ url('join-dropshipper') }}" class="text-indigo-500 font-bold">Dropshipper</a>, baca persyaratan dan teknis menjadi Dropshipper, daftar, lalu melakukan validasi dengan membayar biaya yang telah ditentukan.
                                kemudian anda akan dapat meengakses halaman dashboard dan mulai melakukan kegiatan Dropshipper.
                            </p>
                    </div>
                ...
                <div class="py-4">
                <div class="flex justify-between items-center">
                    <h3 class="font-semibold text-xl leading-5 text-gray-800"> Bagaimana bergabung dengan partnership dengan kami</h3>
                    <button
